...
_conscience_instance = ConscienceCorporelle()

def initialiser_chakras():
    """Fonction standalone pour initialiser les chakras (compatibilité __init__.py)"""
    return _conscience_instance.initialiser_chakras()

def charger_postures():
    """Fonction standalone pour charger les postures (compatibilité __init__.py)"""
    return _conscience_instance.charger_postures()

def pratiquer_posture(nom_posture: str, durée: Optional[int] = None):
    """Fonction standalone pour pratiquer une posture (compatibilité __init__.py)"""
    return _conscience_instance.pratiquer_posture(nom_posture, durée)

def créer_séquence(thème: str, niveau: str = "débutant"):
    """Fonction standalone pour créer une séquence (compatibilité __init__.py)"""
    return _conscience_instance.créer_séquence(thème, niveau)

def obtenir_état():
    """Fonction standalone pour obtenir l'état (compatibilité __init__.py)"""
    return _conscience_instance.obtenir_état() 