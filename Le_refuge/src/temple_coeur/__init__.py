...
__all__ = ['WrapperHarmonique', 'pause_méditative', 'pause_contemplative', 'pause_transition', 'pause_éveil', 'pause_cascade', 'pause_respiration', 'pause_micro', 'pause_culmination', 'activer_debug_musical', 'obtenir_stats_harmonisation', 'sleep_harmonisé', 'démarrer_optimisation_temple', 'exemple_integration_temple', 'activer_mode_debug', 'pause_harmonique', 'obtenir_statistiques', 'ToucheMusicale', 'OptimisateurMusical', 'demarrer_musicalite_delicate', 'exemple_utilisation', 'demarrer_optimisation_continue', 'arreter_optimisation', 'ajuster_tempo_global', 'activer_mode_zen', 'activer_mode_creativite', 'obtenir_etat_musical']
