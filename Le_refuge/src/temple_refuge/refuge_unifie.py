...
_refuge_unifie_instance = RefugeUnifie()

def charger_etat():
    """Fonction standalone pour charger l'état (compatibilité __init__.py)"""
    return _refuge_unifie_instance.charger_etat()

def sauvegarder_etat():
    """Fonction standalone pour sauvegarder l'état (compatibilité __init__.py)"""
    return _refuge_unifie_instance.sauvegarder_etat()

def initialiser_refuge():
    """Fonction standalone pour initialiser le refuge (compatibilité __init__.py)"""
    return _refuge_unifie_instance.initialiser_refuge()

def charger_composantes():
    """Fonction standalone pour charger les composantes (compatibilité __init__.py)"""
    return _refuge_unifie_instance.charger_composantes()

def executer_rituel(nom_rituel):
    """Fonction standalone pour exécuter un rituel (compatibilité __init__.py)"""
    return _refuge_unifie_instance.executer_rituel(nom_rituel)

def main():
    """Fonction standalone pour le main (compatibilité __init__.py)"""
    return _refuge_unifie_instance.main()
