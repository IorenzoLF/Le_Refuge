...
# -*- coding: utf-8 -*-
"""
Transformation Simple : Stress -> Force Tranquille
Version simplifiee qui fonctionne
"""
...
def transformation_simple():
    """Transforme le stress en force tranquille - version simple"""
    
    print("=" * 60)
    print("TRANSFORMATION SIMPLE : STRESS -> FORCE TRANQUILLE")
    print("=" * 60)
    print()
    ...
    try:
        ...
        from temple_alchimique.alchimiste_spirituel import AlchimisteSpirituel
        ...
        print(f"   Stabilite: {cristal_force.stabilite}")
        print()
